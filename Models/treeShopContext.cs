...
{
    public partial class treeShopContext : DbContext
    {
        public treeShopContext()
        {
        }

        public treeShopContext(DbContextOptions<treeShopContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-JQ1H0LS\\NTHACH;Database=treeShop;User Id=sa; Password=Jellythach1;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasIndex(e => e.AcountId, "IX_Accounts")
                    .IsUnique();
            ...
            modelBuilder.Entity<Advertisement>(entity =>
            {
                ...
                entity.Property(e => e.UrlLink).HasMaxLength(150);
            });
            ...
            modelBuilder.Entity<AttributesPrice>(entity =>
            {
                ...
                entity.HasOne(d => d.Attribute)
                    ...
                    .HasConstraintName("FK_AttributesPrices_Attributes1");
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                ...
                entity.HasIndex(e => e.CartId, "IX_Categories")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.CustomerId, "IX_Customers")
                    .IsUnique();
            ...
            modelBuilder.Entity<Page>(entity =>
            {
                ...
                entity.Property(e => e.Tiltle).HasMaxLength(150);
            });
