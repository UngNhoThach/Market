...
namespace Market.Areas.Admin.Controllers
{
    ...
    //    public INotyfService notyfService { get; set; }
        ...
        public AdminRolesController(treeShopContext context, INotyfService notyf)
        {
            _context = context;
            _notyf = notyf;
        }
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName,Description")] Role role)
        {
            if (ModelState.IsValid)
            {
                ...
                _notyf.Success("Tạo quyền truy cập thành công!");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("RoleId,RoleName,Description")] Role role)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notyf.Success("Cập nhập quyền truy cập thành công!");
                return RedirectToAction(nameof(Index));
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'treeShopContext.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
            ...
            await _context.SaveChangesAsync();
            _notyf.Warning("Xóa quyền truy cập thành công!");
            return RedirectToAction(nameof(Index));
        }
